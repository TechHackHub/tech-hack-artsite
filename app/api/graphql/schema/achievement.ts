...
builder.prismaObject('Achievement', {
  fields: (t) => ({
    ...
    subcategory: t.expose('subcategory', {
...
export const AchievementSubcategory = builder.enumType(
...
builder.queryField('getAchievement', (t) =>
  t.prismaField({
    type: 'Achievement',
...
builder.queryField('getAchievements', (t) =>
  t.prismaConnection({
    type: 'Achievement',
    cursor: 'id',
    args: {
...
builder.queryField('createAchievement', (t) =>
  t.prismaField({
    type: 'Achievement',
...
builder.queryField('updateAchievement', (t) =>
  t.prismaField({
    type: 'Achievement',
    authScopes: { isLogin: true },
    args: {
...
builder.mutationField('publishAchievements', (t) =>
  t.int({
    authScopes: { isLogin: true },
    args: {
